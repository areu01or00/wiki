#!/usr/bin/env python3
"""Wiki watch pipeline runner - 2026-06-11 01:02 batch."""
import json
import hashlib
import re
...
# Load batch results
all_results = {}
for batch_file in sorted(TEMP_DIR.glob('watch_run_2026-06-11_01-02_*.json')):
...
# Load existing wiki content (entities/) to cross-check
wiki_files = {name: WIKI_ROOT / 'wiki' / 'entities' / f'{name}.md' for name in profiles.keys()}
